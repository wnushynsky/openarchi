...
export const RELATIONSHIP_TYPES: Record<string, RelationshipTypeDef> = {
  ...
  realization: { label: 'Realization', dash: true, dashPattern: [2, 2], head: 'hollow_arrow', desc: 'Realizes' },
  serving: { label: 'Serving', dash: false, head: 'open_arrow', desc: 'Serves' },
  access: { label: 'Access', dash: true, dashPattern: [2, 2], head: 'open_arrow', desc: 'Accesses' },
  influence: { label: 'Influence', dash: true, dashPattern: [6, 3], head: 'open_arrow', desc: 'Influences' },
  triggering: { label: 'Triggering', dash: false, head: 'filled_arrow', desc: 'Triggers' },
  flow: { label: 'Flow', dash: true, dashPattern: [6, 3], head: 'filled_arrow', desc: 'Flows to' },
